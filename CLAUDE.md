...
**프론트엔드 재설계 진행 중 — Plan 0·1·2·3 머지 완료, Plan 4 진행 중**.
...
| 4 | [admin-editor-redesign](docs/superpowers/plans/2026-04-19-admin-editor-redesign.md) | 🟡 진행 중 | ResizablePanelGroup + MetaRow + BottomBar + SchemaTree 배지 + FieldInspector enum values + ?mode=ui\|yaml 분기 |
